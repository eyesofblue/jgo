...
JGO 是一个不依赖私有基础设施的 Go 服务框架和脚手架，支持 HTTP/JSON、gRPC/protobuf、同时包含两者的 mixed 项目，以及独立公共协议 proto 项目。
...
- [完整示例](examples.md)：Web、gRPC、mixed 和 proto 四类项目示例。
